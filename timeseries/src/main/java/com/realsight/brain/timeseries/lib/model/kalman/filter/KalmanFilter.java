package com.realsight.brain.timeseries.lib.model.kalman.filter;
...
//        System.out.println(predictedStateCovariance);
        // observation
...
//        System.out.println(mExtractionMatrix);
        // update
...
//        System.out.println((mStateCovariance));
//        System.out.println(mExtractionMatrix.multiply(predictedState));
    }
    ...
    public Matrix getNextMeasurement(Matrix h) {
        return h.multiply(mState);
    }
