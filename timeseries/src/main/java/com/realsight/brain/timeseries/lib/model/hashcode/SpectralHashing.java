package com.realsight.brain.timeseries.lib.model.hashcode;
...
public class SpectralHashing {
	
	private PCA pca = null;
	
	public SpectralHashing(final double[][] trainingData) throws FileNotFoundException {
		this.pca = new PCA(new Matrix(trainingData));
